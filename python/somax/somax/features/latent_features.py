...
_config_path = os.path.join(_module_dir, "..", "byol_a_latent_space_encoder", "config.yaml")
...
_weights_path = os.path.join(_module_dir, "..", "byol_a_latent_space_encoder", "pretrained_weights", "AudioNTT2020-BYOLA-64x96d2048.pth")
